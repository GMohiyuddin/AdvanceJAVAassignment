...
<body id="login">
  ...
  <div class="app-cam">
	  <form action="AdminController" method="post">
		<input type="email" name="email" class="text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}">
		<input type="password" name="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
		<div class="submit"><input type="submit" onclick="myFunction()" value="login" name="action"></div>
	</form>
  </div>

			...
			<div class="container-fluid px-lg-5">
				...
				<nav class="py-4">
					...
					<ul class="menu mt-2">
						...
						</label> <a class="active" href="#">My purchase <span class="fa fa-angle-down"
								aria-hidden="true"></span></a> <input type="checkbox" id="drop-2" />
							<ul>
								<li><a href="cart.jsp">Cart</a></li>
								<%List<Wishlist> list = WishlistDao.getwishlistwithcusid(c.getId()); %>
								<li><a href="wishlist.jsp">Wish list (<%out.print(list.size());%>)</a></li>
							</ul>
						</li>
						<li>
							<!-- First Tier Drop Down --> <label for="drop-2" class="toggle">Drop

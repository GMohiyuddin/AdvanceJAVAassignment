                ...
                <nav class="py-4">
					...
					<ul class="menu mt-2">
						...
						<li>
							...
							<ul>
								<li class="active"><a href="Customer-Profile.jsp">Profile</a></li>
						...
						<%List<Cart> list1 = CartDao.getCartByCusId(c.getId()); %>
						<li><a href="Customer-Cart.jsp">View Cart (<%=list1.size() %>) </a></li>
						
						<%List<Wishlist> list2 = WishlistDao.getwishlistwithcusid(c.getId()); %>
            ...
            <div class="row contact-main-info mt-5">
                <div class="col-md-12 contact-right-content">
                    <form action="CustomerController" method="post">
                        ...
                        <input type="tel" name="Contact" value="<%=c.getContact()%>">
                        <input type="text" name="Address" value="<%=c.getAddress()%>">
                        <input type="email" class="email" name="Email" value="<%=c.getEmail()%>">
